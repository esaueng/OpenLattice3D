    ...
    <div className="panel-content">
      ...
      {hasModelOrDemo && (
        <section className="panel-section">
          ...
          <div className="row">
            <label>Remove Features:</label>
            <select
              title="Remove features thinner than this by morphological opening. Needs the export grid to resolve the size — the run log says so when it cannot."
            ...
            >
              ...
              <option value={2.0}>Under 2.0mm</option>
            </select>
          </div>
